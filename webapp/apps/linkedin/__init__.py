...
FACEBOOK_GRAPH_URL = "https://graph.instagram.com/"
FACEBOOK_WWW_URL = "https://www.instagram.com/"
...
class GraphAPI(object):
    ...
    def get_auth_url(self, app_id, canvas_url, perms=None, **kwargs):
        ...
        url = "{0}/{1}".format(
            FACEBOOK_WWW_URL, FACEBOOK_OAUTH_DIALOG_PATH
        )
